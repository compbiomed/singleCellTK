    ...
    sidebarLayout(
      sidebarPanel(
        fluidRow(
          ...
          column(3,
                 br(),
                 actionButton("Diffex_hideAllSections", "Hide All")
          ),
          column(3,
                 br(),
                 actionButton("Diffex_showAllSections", "Show All")
          )
        ),
        br(),
                 ...
                 wellPanel(
                   ...
                   shinyjs::hidden(
                     tags$div(id = "de6",
                              wellPanel(
                                uiOutput("savedRes"),
                                withBusyIndicatorUI(actionButton("loadResults", "Load Saved Results"))
                              )
                     )
                   ),
                     ...
                     actionButton("diffex3", "Options"),
                       tags$div(id = "de3",
                                wellPanel(
                                  ...
                                  fluidRow(
                                    column(width = 1,
                                           checkboxInput("displayHeatmapRowLabels", "Row Labels",
                                                         value = TRUE)
                                           ),
                                    column(width = 1,
                                           offset = 4,
                                  ...
                                  fluidRow(
                                    ...
                                    column(width = 1,
                                           offset = 4, checkboxInput("clusterColumns", "Cluster Columns",
                                                         value = TRUE)
                                           )
                                  ),
        ...
        shinyjs::hidden(
          tags$div(id = "de4",
                   wellPanel(
                     downloadButton("downloadGeneList",
                                    "Download(.csv)")
                   )
          )
        ),
        ...
        shinyjs::hidden(
          tags$div(id = "de7",
                   wellPanel(
                     ...
                     withBusyIndicatorUI(actionButton("saveBiomarker",
                                                      "Save Biomarker")
                                         ),
