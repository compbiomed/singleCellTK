...
x <- preprocessMeta(sce.qc@metadata$scater[[1]]$addPerCellQC)
t(as.data.frame(x)) %>%
...
for (sample in samples) {
  ...
  x <- preprocessMeta(sce.qc@metadata$runScrublet[[sample]])
...
for (sample in samples) {
  ...
  for (resolution in resolutions) {
    ...
    cat("##### Parameters {.tabset .tabset-fade} \n\n")
    x <- preprocessMeta(sce.qc@metadata$runDoubletFinder[[sample]])
    cat(t(as.data.frame(x)) %>%
      knitr::kable(format = "html") %>% kableExtra::kable_styling() %>%
      kableExtra::scroll_box(width = "80%"))
...
for (sample in samples){
  ...
  cat("#### Parameters {.tabset .tabset-fade} \n\n")
  x <- preprocessMeta(sce.qc@metadata$runDoubletCells[[sample]])
  cat(t(as.data.frame(x)) %>%
    knitr::kable(format = "html") %>% kableExtra::kable_styling() %>%
    kableExtra::scroll_box(width = "80%"))
...
for (sample in samples){
  ...
  cat("#### Parameters {.tabset .tabset-fade} \n\n")
  x <- preprocessMeta(sce.qc@metadata$runCxds[[sample]])
  cat(t(as.data.frame(x)) %>%
    knitr::kable(format = "html") %>% kableExtra::kable_styling() %>%
    kableExtra::scroll_box(width = "80%"))
...
for (sample in samples){
  ...
  cat("#### Parameters {.tabset .tabset-fade} \n\n")
  x <- preprocessMeta(sce.qc@metadata$runBcds[[sample]])
  cat(t(as.data.frame(x)) %>%
    knitr::kable(format = "html") %>% kableExtra::kable_styling() %>%
    kableExtra::scroll_box(width = "80%"))
...
for (sample in samples){
  ...
  cat("#### Parameters {.tabset .tabset-fade} \n\n")
  x <- preprocessMeta(sce.qc@metadata$runCxdsBcdsHybrid[[sample]])
  cat(t(as.data.frame(x)) %>%
    knitr::kable(format = "html") %>% kableExtra::kable_styling() %>%
    kableExtra::scroll_box(width = "80%"))
...
for (sample in samples){
  ...
  cat("#### Parameters {.tabset .tabset-fade} \n\n")
  x <- preprocessMeta(sce.qc@metadata$runDecontX[[sample]])
  cat(t(as.data.frame(x)) %>%
    knitr::kable(format = "html") %>% kableExtra::kable_styling() %>%
    kableExtra::scroll_box(width = "80%"))
  cat("\n\n")
