...
singleCellTK-QC (SCTK-QC) is a streamlined quality control(QC) pipeline for single cell RNA sequencing data. SCTK-QC performs comprehensive quality control for cell count data, including general QC metrics, doublet detection and ambient RNA detection and correction. This report contains information for the output of each QC function, visualization of QC metrics and parameters used to run each QC function. 
<br />
<br />
