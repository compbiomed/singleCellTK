...
runHVG <- params$runHVG
plotHVG <- params$plotHVG
runDimRed <- params$runDimRed
plotJackStraw <- params$plotJackStraw
plotElbowPlot <- params$plotElbowPlot
plotHeatmaps <- params$plotHeatmaps
runClustering <- params$runClustering
plotTSNE <- params$plotTSNE
plotUMAP <- params$plotUMAP
minResolution <- params$minResolution
maxResolution <-params$maxResolution

runMSClusters <- params$runMSClusters
runMSBioGroup <- params$runMSBioGroup
```
