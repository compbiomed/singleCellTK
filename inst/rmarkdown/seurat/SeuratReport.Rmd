...
metadata(data)$seurat$plots$hvg <- Labeled_Variable_data
...
## Output Data
The output SingleCellExperiment object is saved in the working directory which contains all of the stored computations and plots. This object can be loaded into the singleCellTK R toolkit to further inspect and visualize the data and plots through a interactive user interface. Additionally, all figures and tables have been stored to the working directory.
