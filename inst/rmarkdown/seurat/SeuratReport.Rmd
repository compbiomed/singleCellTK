...
top9 <- top9$gene.id
heatmap_complete <- seuratGenePlot(data, plotType = "heatmap", features = top9, groupVariable = group, ncol = 1, cols = c("grey", "blue")) + theme(axis.text.y = element_text(size = 8), legend.text = element_text(size = 8), legend.key.size = unit(0.5, "cm"), legend.position = "top")
heatmap_complete
```
