...
for(i in 1:(((maxResolution-minResolution)*10)+1)){
  ...
  cat(headingClust," Samples {-} \n\n")
      p1 <- seuratReductionPlot(data, useReduction = "tsne", groupBy = group, showLegend = TRUE)
  p2 <- seuratReductionPlot(data, useReduction = "umap", groupBy = group, showLegend = TRUE)
  # p3 <- p1 + p2
  # print(p3)
  print(p1)
  print(p2)
  cat("\n\n")
    ...
    cat(headingClust," Samples separated {-} \n\n")
      p1 <- seuratReductionPlot(data, useReduction = "tsne", splitBy = group, showLegend = TRUE)
  p2 <- seuratReductionPlot(data, useReduction = "umap", splitBy = group, showLegend = TRUE)
  # p3 <- p1 + p2
  # print(p3)
  print(p1)
  print(p2)
