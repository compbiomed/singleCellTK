...
for(i in 1:(((maxResolution-minResolution)*10)+1)){
  ...
  cat(headingClust," Clusters {-} \n\n")
    p1 <- plotSeuratReduction(data, useReduction = "tsne", groupBy = paste0("Seurat_louvain_Resolution", j), showLegend = TRUE)
  p2 <- plotSeuratReduction(data, useReduction = "umap", groupBy = paste0("Seurat_louvain_Resolution", j), showLegend = TRUE)
  j <- j + 0.1
  # p3 <- p1 + p2
  # print(p3)
  print(p1)
  ...
  cat(headingClust," Samples {-} \n\n")
      p1 <- plotSeuratReduction(data, useReduction = "tsne", groupBy = biological.group, showLegend = TRUE)
  p2 <- plotSeuratReduction(data, useReduction = "umap", groupBy = biological.group, showLegend = TRUE)
  # p3 <- p1 + p2
  # print(p3)
  print(p1)
  print(p2)
  cat("\n\n")
    ...
    cat(headingClust," Samples separated {-} \n\n")
      p1 <- plotSeuratReduction(data, useReduction = "tsne", splitBy = biological.group, showLegend = TRUE)
  p2 <- plotSeuratReduction(data, useReduction = "umap", splitBy = biological.group, showLegend = TRUE)
  # p3 <- p1 + p2
  # print(p3)
  print(p1)
  print(p2)
  cat("\n\n")
      ...
      p1 <- plotSeuratReduction(data, useReduction = "tsne", groupBy = phenotype.groups, showLegend = TRUE)
  p2 <- plotSeuratReduction(data, useReduction = "umap", groupBy = phenotype.groups, showLegend = TRUE)
  # p3 <- p1 + p2
  # print(p3)
  print(p1)
  print(p2)
