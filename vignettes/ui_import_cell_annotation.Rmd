---
title: "Manipulate Cell Annotations"
---
...
After successfully uploading single-cell dataset, users are allowed to manipulate the cell level annotation in the UI. Users can enter the interface as instructed by the screenshot above. With this interface, users can either upload extra annotations or edit existing annotations.  
