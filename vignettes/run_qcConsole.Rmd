...
```{r rundropletqc, eval=FALSE, message = TRUE}
...
```{r scatter_emptydrops, fig.height = 6, fig.width = 8, fig.align="center"}
...
```{r run_kneeplot_barcoderank, message=FALSE, warning=FALSE, fig.align="center", fig.height = 6, fig.width = 8}
...
```{r, "Count Violin after filtering", eval = TRUE, echo = TRUE, warning=FALSE, message=FALSE}
...
```{r load_data2, eval=FALSE, message=FALSE}
...
```{r dimensionalityreduction, eval=FALSE, warning=FALSE, message=FALSE}
# UMAP:
...
```{r umap_doubletcells_plots, message=FALSE, warning=FALSE}
...
```{r plot_umap_doubletcells, fig.wide = TRUE, fig.height = 12, fig.width = 10}
...
```{r umap_decontx_plots, warning=FALSE, message=FALSE}
...
```{r run_doubletcells, eval = FALSE, message=FALSE}
