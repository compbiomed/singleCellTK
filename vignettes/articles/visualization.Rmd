...
sce <- seuratNormalizeData(sce, "counts")
sce <- seuratScaleData(sce)
sce <- seuratFindHVG(sce)
sce <- seuratPCA(sce)
sce <- seuratFindClusters(sce)
...
plotSCEDimReduceColData(inSCE = sce,                             # Specify the object first
