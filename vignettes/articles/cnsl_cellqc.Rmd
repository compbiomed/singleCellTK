...
```{r load_geneset,  message = FALSE, warning = FALSE}
...
| `scDblFinder_doublet_score`              | Doublet score                                                 | `runScDblFinder()`   | [scran](https://bioconductor.org/packages/release/bioc/html/scran.html)         |
