...
Remove detected doublets from scDblFinder:
```{r}
pbmc.combined <- subsetSCECols(pbmc.combined, colData = 'scDblFinder_doublet_call == "Singlet"')
```
