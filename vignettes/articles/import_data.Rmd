...
To view detailed instructions on how to import data, please select 'Interactive Analysis' for importing data through the shiny application or 'Console Analysis' for importing through the R console from the tabs below: <br>
