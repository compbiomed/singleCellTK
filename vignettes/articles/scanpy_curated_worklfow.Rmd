...
sce <- runScanpyPCA(inSCE = sce, useAssay = "scanpyNormData", reducedDimName = "scanpyPCA")
...
sce <- runScanpyTSNE(inSCE = sce, useReduction = "scanpyPCA", reducedDimName = "scanpyUMAP")
```

```{r, warning=FALSE, message=FALSE}
sce <- runScanpyUMAP(inSCE = sce, useReduction = "scanpyPCA", reducedDimName = "scanpyTSNE")
```
...
sce <- runScanpyFindClusters(inSCE = sce, useAssay = "scanpyScaledData", useReduction = "scanpyPCA", algorithm = "leiden")
```
...
plotScanpyEmbedding(sce, reducedDimName = "scanpyPCA", color = 'Scanpy_leiden_1')
plotScanpyEmbedding(sce, reducedDimName = "scanpyTSNE", color = 'Scanpy_leiden_1')
...
sce <- runScanpyFindMarkers(inSCE = sce, colDataName = "Scanpy_leiden_1")
...
plotScanpyMarkerGenesHeatmap(sce, groupBy = 'Scanpy_leiden_1')
plotScanpyMarkerGenesDotPlot(sce, groupBy = 'Scanpy_leiden_1')
plotScanpyMarkerGenesMatrixPlot(sce, groupBy = 'Scanpy_leiden_1')
```
