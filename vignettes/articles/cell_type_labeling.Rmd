...
SCTK does not have a quick visualization at this point. But users can go to the [CellViewer](visualization.html) to create a scatter plot using the pre-generated embedding and color it with the cell type labeling result.  
