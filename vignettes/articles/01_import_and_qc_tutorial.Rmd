...
This tutorial focuses on how to import and QC the example PBMC3k data stored in an RDS object. For a more detailed overview, refer to the [advanced user guide on importing](import_data.html) for different function call syntax. 
