...
sce <- runDEAnalysis(inSCE = sce, method = "wilcox", useAssay = "seuratNormData", 
...
```{R getDE, eval=FALSE}
DEG <- getDEGTopTable(sce, "c2_VS_c4_c5")
head(DEG)
```
...
```{R plotDEVolcano, eval=FALSE, message=FALSE, warning=FALSE, cache=TRUE, fig.align="center"}
