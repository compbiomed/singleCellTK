...
# sce <- setTopHVG(inSCE = sce, method = "vst", featureSubsetName = "featureSubset") # updated above function
...
sce <- runSeuratPCA(inSCE = sce, useAssay = "seuratNormData", reducedDimName = "seuratPCA", nPCs = 20, scale = TRUE)
