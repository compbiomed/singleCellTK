...
```{r, coldata_drop2, echo=FALSE, eval=TRUE}
...
For additional cell-filtered quality control with singleCellTK, please refer to our [*Cell QC* documentation](cnsl_cellqc.html).
