...
Parameters for seuratFindHVG include useAssay (specify the name of the scaled assay, defaults to "counts" for "vst" and "seuratScaledData" for other methods) and hvgMethod (specify the method to use for variable genes computation, defaults to "vst").
