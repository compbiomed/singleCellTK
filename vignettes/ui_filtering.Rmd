---
title: Using the UI to filtering SCE objects
---

This section of the toolkit will allow users to filter their SCE objects after running QC metrics on them. Below is a guide on how to navigate the page.

![](ui_screenshots/filter_landing.png)
