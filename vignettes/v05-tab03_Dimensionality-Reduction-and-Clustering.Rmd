...
It is also possible to cluster the data using [K-Means](https://en.wikibooks.org/wiki/Data_Mining_Algorithms_In_R/Clustering/K-Means) or [Clara](https://en.wikibooks.org/wiki/Data_Mining_Algorithms_In_R/Clustering/CLARA). Choose the data to use for clustering, the clustering algorithm, the number of clusters, and a name for the clustered data. The clustering results will be stored in the annotation data frame and be available on the other tabs.
