...
```{R de_prep, eval=TRUE, message=FALSE, warning=FALSE, cache=TRUE, fig.align="center"}
...
```{R plotMarkers, eval=TRUE, cache=TRUE, fig.align="center", fig.width=9, fig.height=6}
