...
![check algorithms](qc_ui_checkAlgo.png)\

## Other settings before running

![general](qc_ui_general.png)\
...
A UMAP embedding will be calculated when running SCTK QC workflow, and it will be used across all QC algorithms that requires a UMAP. Here are the explanation of the parameters.  
