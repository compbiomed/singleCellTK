...
```{r eval=FALSE}
exportSCEtoFlatFile(sce, "example_sce")
```
...
## Vignettes
Refer following guides for detailed examples 
* [Import Data](import_scRNAseq_data_as_SCE.html)
* [Perform Quality Control](run_qc.html)
* [Visualize Data](visualize_results.html)
