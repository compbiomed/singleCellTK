...
#'   sample(rownames(mouse_brain_subset_sce), 50)
#'   mouse_brain_subset_symbol <- convert_gene_ids(inSCESet = mouse_brain_subset_sce,
#'                                              in_symbol = "SYMBOL",
#'                                              out_symbol = "ENSEMBL",
#'                                              database = "org.Mm.eg.db")
#'   sample(rownames(mouse_brain_subset_symbol), 50)
#' }
#'
