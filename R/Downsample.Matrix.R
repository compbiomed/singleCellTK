...
#' @param minCount Numeric. The minimum number of reads found for a gene to be considered detected.
#' @param minCells Numeric. The minimum number of cells a gene must have at least 1 read in for it to be considered detected.
...
#' @param conditions A vector of conditions, such as treatment or batch. Passed as colData(SCtkExperiment)$treatment.
#' @param genelist Optional vector of genes to be searched for differential expression. If provided, diffexp will not be performed on the original data.
