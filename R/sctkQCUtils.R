...
generateMeta <- function(dropletSCE = NULL,
  ...
  WorkFlowData = c(
    ...
    DecontXUMAPBP = 'UMAP dimension reduction generated by decontX, which is run with background count matrix',
...
generateHTANMeta <- function(dropletSCE = NULL,
  ...
  htan_patient_id <- paste(stringr::str_split(htan_biospecimen_id, '_', simplify=T)[1:2], collapse='_')
