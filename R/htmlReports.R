...
#'  in the \code{singleCellTK} user interface.
#' @export
seuratReportDimRed <- function(inSCE,
                                outputFile = NULL,
                                outputDir = NULL,
                                subtitle = NULL,
                                authors =  NULL,
...
#'  in the \code{singleCellTK} user interface.
#' @export
seuratReportNorm <- function(inSCE,
                               outputFile = NULL,
                               outputDir = NULL,
                               subtitle = NULL,
                               authors =  NULL,
...
#'  in the \code{singleCellTK} user interface.
#' @export
seuratReportFeatureSelection <- function(inSCE,
                             outputFile = NULL,
                             outputDir = NULL,
                             subtitle = NULL,
                             authors =  NULL,
...
#'  in the \code{singleCellTK} user interface.
#' @export
seuratReportScaleData <- function(inSCE,
                           outputFile = NULL,
                           outputDir = NULL,
                           subtitle = NULL,
                           authors =  NULL,
...
#'  in the \code{singleCellTK} user interface.
#' @export
seuratReportClustering <- function(inSCE,
                           outputFile = NULL,
                           outputDir = NULL,
                           subtitle = NULL,
                           authors =  NULL,
...
#'  in the \code{singleCellTK} user interface.
#' @export
seuratReportMarkerSelection <- function(inSCE,
                           outputFile = NULL,
                           outputDir = NULL,
                           subtitle = NULL,
                           authors =  NULL,
