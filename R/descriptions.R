...
.descriptionDoubletCells <- function() {
  return(list(
    introduction = "DoubletCells is a doublet detection algorithm in the `scran`
...
.descriptionDecontX <- function() {
  return(list(
    introduction = "In droplet-based single cell technologies,
            ...
            lead to contamination. DecontX is a Bayesian method for the
            identification of the contamination level at a cellular level.",
