...
#' @param sampleDirs vector of Paths to the folders containing the DropEst cell.counts.rds output
#' #' @param sampleNames vector of sample names that will be appended to cell names of each SCE
...
#library("tidyverse")
#smplpath <- '/Users/sbandya/Desktop/dropest_samples/'
#smplnames <- c('sample1','sample2','sample3')
#smplnames <- c('sample1')
#smpldirs <- as.list(paste0(smplpath,smplnames))
#print(smpldirs)
#sce <- importDropEst(sampleDirs = smpldirs, sampleNames = smplnames , dataType='filtered')
