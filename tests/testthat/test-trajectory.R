...
test_that(desc = "Testing TSCAN", {
  ...
  sce <- runTSCANClusterDEAnalysis(inSCE = sce, useClusters = 1)
  ...
  TSCANPseudotimeHeatmapPlot <- plotTSCANPseudotimeHeatmap(inSCE = sce, 
  ...
  ClusterPseudoPlot <- plotTSCANClusterPseudo(inSCE = sce, 
                                              ...
                                              pathIndex = NULL, 
                                              useReducedDim = "TSNE")
  TSCANDEgenesPlot <- plotTSCANDEgenes(inSCE = sce, 
                                       geneSymbol = "CD74", 
                                       useReducedDim = "TSNE")
