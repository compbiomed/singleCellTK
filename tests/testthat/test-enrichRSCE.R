...
test_that("Should fail when the gene list is empty", {
  expect_error(enrichRSCE(mouseBrainSubsetSCE, "counts", NULL,
                          "GO_Cellular_Component_2017"),
